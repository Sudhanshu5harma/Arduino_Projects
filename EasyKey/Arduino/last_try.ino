...
void wifi_init()
{
      ...
      if(!No_IP)
      {
        ...
        connect_wifi("AT+CWJAP=\"NETGEAR31\",\"ajourneli003\"",7000);         //provide your WiFi username and password here
...
void Send()
{
      webpage = "<h1>Welcome to EasyKey</h1><body bgcolor=f0f0f0>";
      sendwebdata(webpage);
      webpage=name;
      webpage+=dat;
      sendwebdata(webpage);
